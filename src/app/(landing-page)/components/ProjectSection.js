  ...
  const projects = [
    {
      ...
      description: "A real time application for chatting with friends.",
      fullDescription:
        "This project uses Firebase to store chat messages and user data. The front-end is built with React.It even features sending pictures in real time.",
      image: "/summarization.png",
      techStack: ["React", "Firebase", "TailwindCSS", "NodeJS"],
    },
    {
      id: 2,
